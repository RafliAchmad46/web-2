...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (empty($_POST['pegawai_id']) || empty($_POST['kartu_diskon_id'])) {
        ...
        if ($anggota->create()) {
            ...
            $error_message = "Gagal menambahkan anggota.";
        }
    }
}
?>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-user-plus me-1"></i> Form Tambah Anggota
                        </div>
                            ...
                            <form method="POST" action="<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>">
                                <div class="form-group mb-3">
                                    ...
                                    <select id="pegawai_id" name="pegawai_id" class="form-control" required>
                                        ...
                                        <option value="<?= $pegawaiRow['id'] ?>"
                                            <?= (isset($_POST['pegawai_id']) && $_POST['pegawai_id'] == $pegawaiRow['id']) ? 'selected' : '' ?>>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select id="kartu_diskon_id" name="kartu_diskon_id" class="form-control" required>
                                        ...
                                        <option value="<?= $kartuRow['id'] ?>"
                                            <?= (isset($_POST['kartu_diskon_id']) && $_POST['kartu_diskon_id'] == $kartuRow['id']) ? 'selected' : '' ?>>
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" id="status_aktif"
                                        name="status_aktif"
                                        <?= (isset($_POST['status_aktif'])) ? 'checked' : 'checked' ?>>
