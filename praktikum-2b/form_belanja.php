...
<body>
    <div class="container mt-5">
        <div class="col-4" style="float: right;">
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item bg-light">TV : 9.000.000</li>
                    <li class="list-group-item bg-light">Kulkas : 4.500.000</li>
                    <li class="list-group-item bg-light">Mesin Cuci : 6.000.000</li>
                </ul>
            </div>
        ...
        if (isset($_POST['proses'])) {
            ...
            echo 'Produk yang dipilih: ' . htmlspecialchars($produk) . '<br>';
