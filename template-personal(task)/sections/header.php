        ...
        <div class="row gx-5 align-items-center">
            <div class="col-xxl-5">
                <div class="text-center text-xxl-start">
                    ...
                    <div class="fs-3 fw-light text-muted">Engineer</div>
                    <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">MARI TERHUBUNG DENGAN SAYA</span></h1>
            ...
            <div class="col-xxl-7">
                <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                    <div class="profile bg-gradient-primary-to-secondary">
                        <img class="profile-img" src="assets/poto.png" alt="..." />
                        <!-- Add your SVG dots here -->
                    </div>
                </div>
            </div>
        </div>
