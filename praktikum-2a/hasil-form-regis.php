    ...
    <table class="table border border-2 border-success mt-3 text-white w-75 mx-auto">
      ...
      <tbody>
        ...
        <tr>
          <td>Program Studi</td>
          <td>:</td>
          <td><?= isset($prodi) ? $prodi : ''; ?></td>
        </tr>
        <tr>
          <td>Skill</td>
          <td>:</td>
          <td><?= isset($skill_pilihan) ? implode(", ", $skill_pilihan) : ''; ?></td>
        </tr>
        <tr>
          <td>Skor Skill</td>
          <td>:</td>
          <td><?= isset($skor_skill) ? $skor_skill : ''; ?></td>
        </tr>
        <tr>
          <td>Kategori Skill</td>
          <td>:</td>
          <td><?= isset($kategori_skill) ? $kategori_skill : ''; ?></td>
        </tr>
        <tr>
          <td>Email</td>
          <td>:</td>
